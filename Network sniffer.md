Sniffer is a program or device that monitors data traveling over a network. Sniffers can be used for packet analyzing and if packet are sent in plain text the sniffer can look at the packet content. 
